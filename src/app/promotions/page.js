...
import { activePromotions, upsellConfig } from "@/lib/promotionsConfig";
    ...
    <main className="flex flex-col">
      <Section background="white" className="py-20">
        <div className="space-y-12">
          <header className="mx-auto max-w-[513px] space-y-2 text-center sm:max-w-3xl sm:text-left">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:gap-8">
            ...
            {/* Upsell Promo Card */}
            {upsellConfig.active && (
              <UpsellPromoCard config={upsellConfig} />
            )}
          </div>
...
function PromoCard({ promo }) {
  return (
    <article className="mx-auto flex w-full max-w-[513px] flex-col space-y-4 sm:max-w-none">
      {/* Header Badge */}
      <div>
...
function UpsellPromoCard({ config }) {
  return (
    <article className="mx-auto flex w-full max-w-[513px] flex-col space-y-4 sm:max-w-none">
      {/* Header Badge */}
      <div>
