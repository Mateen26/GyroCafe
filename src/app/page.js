...
export default function Home() {
  return (
    <main className="flex flex-col">
      ...
      <Section background="red" className="py-12 md:py-16 lg:py-20">
        <div className="text-center space-y-3 px-4 sm:px-6">
          <p className="text-base md:text-lg uppercase tracking-[0.4em] text-white/70">
            Gyro Cafe on the Feed
          </p>
          <h2 className="text-2xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold uppercase tracking-tight text-white leading-tight">
            Fresh from Our Grill · Live from @GyroCafeBK
          </h2>
          <p className="text-sm sm:text-base leading-relaxed text-white/80 md:text-lg max-w-3xl mx-auto px-2">
